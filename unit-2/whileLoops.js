...
console.log(`Spider-Man lands in teh ${structure}!`);

/* 
    ? Do While Loop: also loops through a block of code while a specified condition is true BUT...
        ! loop will run the code block ONCE, BEFORE checking if the conidtion is true and will keep running as long as the condition stays true
        ...
        - Works just like while loops with the exeception that it will run out code block at least once
